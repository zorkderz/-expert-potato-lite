...
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/zorkderz/expert-potato-lite@main/css/mdui_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/zorkderz/expert-potato-lite@main/css/mdui_v2.min.css">'
  );
}
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/zorkderz/expert-potato-lite@main/css/nexmoe_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/zorkderz/expert-potato-lite@main/css/nexmoe_v2.min.css">'
  );
}
document.write(
  '<script src="https://cdn.jsdelivr.net/gh/zorkderz/expert-potato-lite@main/js/mdui.min.js"></script>'
);
document.write(
  '<script src="https://cdn.jsdelivr.net/gh/zorkderz/expert-potato-lite@main/js/flv.min.js"></script>'
);
document.write(
  '<script src="https://cdn.jsdelivr.net/gh/zorkderz/expert-potato-lite@main/js/DPlayer.min.js"></script>'
);
document.write(
...
<script src="https://cdn.jsdelivr.net/gh/zorkderz/expert-potato-lite@main/js/ace.js"></script>
<script src="https://cdn.jsdelivr.net/gh/zorkderz/expert-potato-lite@main/js/ext-language_tools.js"></script>
	`;
  $("#content").html(content);
