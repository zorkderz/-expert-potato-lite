...
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="https://raw.githubusercontent.com/zorkderz/expert-potato-lite/main/css/mdui_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="https://raw.githubusercontent.com/zorkderz/expert-potato-lite/main/css/mdui_v2.min.css">'
  );
}
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="https://raw.githubusercontent.com/zorkderz/expert-potato-lite/main/css/nexmoe_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="https://raw.githubusercontent.com/zorkderz/expert-potato-lite/main/css/nexmoe_v2.min.css">'
  );
}
document.write(
  '<script src="https://raw.githubusercontent.com/zorkderz/expert-potato-lite/main/js/mdui.min.js"></script>'
);
document.write(
  '<script src="https://raw.githubusercontent.com/zorkderz/expert-potato-lite/main/js/flv.min.js"></script>'
);
document.write(
  '<script src="https://raw.githubusercontent.com/zorkderz/expert-potato-lite/main/js/DPlayer.min.js"></script>'
);
document.write(
...
<div class="mdui-container">
  ...
  if (UI.credits) {
    ...
    <div style="margin-bottom: 20px" class="mdui-center mdui-text-center">
      <a href="https://github.com/zorkderz/expert-potato-lite" target="_blank">
        <img src="https://img.shields.io/static/v1?" alt="goind - extended">
      </a>
    </div>
    </div>
    `
...
<script src="https://raw.githubusercontent.com/zorkderz/expert-potato-lite/main/js/ace.js"></script>
<script src="https://raw.githubusercontent.com/zorkderz/expert-potato-lite/main/js/ext-language_tools.js"></script>
	`;
  $("#content").html(content);
